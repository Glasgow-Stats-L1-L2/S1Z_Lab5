...
HEARTDISEASE$TenYearCHD<-as.factor(HEARTDISEASE$TenYearCHD)
...
```{r, echo = FALSE, out.width = "80%", fig.cap = "Created with ChatGPT"}
...
## An Introduction to Logistic Regression Modelling 
